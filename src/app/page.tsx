            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{ marginTop: '24px' }}>
                  ...
                  <textarea
                    value={clientSettings.customInstructions}
                    onChange={(e) => setClientSettings({...clientSettings, customInstructions: e.target.value})}
                    rows={6}
                    style={{
                      ...inputStyle,
...
• Client is based in EST timezone"
                  ...
                  <div style={{
                    ...
                    <strong>💡 Pro Tip:</strong> Use this to prevent AI hallucinations! Add rules like "Never assume meeting locations" or "Client books all meetings via Teams" to keep responses accurate.
                  </div>
                </div>
